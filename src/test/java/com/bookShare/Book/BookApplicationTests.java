...
public class BookApplicationTests {
	...
	public void testGetAllBooks() throws Exception {
		Book book1 = new Book(1, "Naslov knjige 1", "Opis knjige 1", "Avtor 1", "pot/do/slike1.jpg");
		Book book2 = new Book(2, "Naslov knjige 2", "Opis knjige 2", "Avtor 2", "pot/do/slike2.jpg");
	...
	public void createBookSimpleTest() throws Exception {
		Book book = new Book(1, "Naslov knjige", "Opis knjige", "Avtor knjige", "pot/do/slike.jpg");
